# run-migration.ps1
# Скрипт для выполнения миграций в notifications-service
...
Write-Host "Database Migrations for notifications-service" -ForegroundColor Cyan

if (!(Test-Path "package.json")) {
    Write-Host "Error: package.json not found. Make sure you are in notifications-service directory" -ForegroundColor Red
    exit 1
}
