...
# Скрипт для генерации новых миграций в notifications-service
...
if (!(Test-Path "package.json")) {
    Write-Host "❌ Ошибка: package.json не найден. Убедитесь, что вы в директории notifications-service" -ForegroundColor Red
    exit 1
}
